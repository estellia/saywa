...
{
    public class PositionRolesService : BaseService<PositionRoles>
    {
        ...
        public PositionRolesService(ConnectionFactory connFactory) :base(connFactory, "tb_PositionRoles")
        {
        }
